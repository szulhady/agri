...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/scheduleIpah2.vue?vue&type=template&id=668419e5&
...
// CONCATENATED MODULE: ./pages/scheduleIpah2.vue?vue&type=template&id=668419e5&
...
/* harmony default export */ var scheduleIpah2vue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getScheduleIpah1: function () {
      this.$axios // .$get("http://127.0.0.1:5000/api/schedule/ipah2")
      .$get("http://159.223.55.150/api/schedule/ipah2") // .$get("http://139.59.109.48/api/schedule/ipah2")
      .then(response => {
        response.forEach(i => {
    ...
    getScheduleIpah1Nutrient: function () {
      this.$axios // .$get("http://127.0.0.1:5000/api/schedule/ipah2/nutrient")
      .$get("http://159.223.55.150/api/schedule/ipah2/nutrient") // .$get("http://139.59.109.48/api/schedule/ipah2/nutrient")
      .then(response => {
        response.forEach(i => {
