...
/* harmony default export */ var scheduleIpah1vue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    checkScheduleNutrient: function () {
      ...
      if (this.durationNutrient) {
        this.allDurationNutrient.push(this.durationNutrient.toFixed(2)); // this.durationNutrient2 = this.durationNutrient.toFixed(2);
      } //
