exports.ids = [74,21,40,42,43,44,45];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/scheduleTkpmPagoh.vue?vue&type=template&id=5280ead0&
...
// CONCATENATED MODULE: ./pages/scheduleTkpmPagoh.vue?vue&type=template&id=5280ead0&
...
/* harmony default export */ var scheduleTkpmPagohvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getScheduleIpah1: function () {
      this.$axios // .$get("http://127.0.0.1:5000/api/schedule/tkpmPagoh")
      .$get("http://159.223.55.150/api/schedule/tkpmPagoh") // .$get("http://139.59.109.48/api/schedule/tkpmPagoh")
      .then(response => {
        console.log(response);
        response.forEach(i => {
    ...
    getScheduleIpah1Nutrient: function () {
      this.$axios // .$get("http://127.0.0.1:5000/api/schedule/tkpmPagoh/nutrient")
      .$get("http://159.223.55.150/api/schedule/tkpmPagoh/nutrient") // .$get("http://139.59.109.48/api/schedule/tkpmPagoh/nutrient")
      .then(response => {
        response.forEach(i => {
    ...
    sendScheduleIpah2: function (date, time, block, duration, substance) {
      this.$axios // .$post("http://127.0.0.1:5000/api/setSchedule/tkpmPagoh", {
      .$post("http://159.223.55.150/api/setSchedule/tkpmPagoh", {
    ...
    sendScheduleIpah1Nutient: function (date, duration) {
      this.$axios // .$post("http://139.59.109.48/api/setSchedule/tkpmPagoh/nutrient", {
      // .$post("http://127.0.0.1:5000/api/setSchedule/tkpmPagoh/nutrient", {
      .$post("http://159.223.55.150/api/setSchedule/tkpmPagoh/nutrient", {
        date: date,
        time: "05:00:00",
        duration: duration
      }).then(response => {
    ...
    sendSchedule: function () {
      this.sendScheduleIpah2(this.selectedDate, this.allTime, this.allBlock2, this.allDuration, this.allSubstance);
