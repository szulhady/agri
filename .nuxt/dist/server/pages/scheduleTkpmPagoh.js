...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".userInput{display:flex;align-items:center;justify-content:center;height:60px}.v-messages__message{font-size:.5rem!important}.short{width:80px}.v-select__selection--comma{font-size:.8rem}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
