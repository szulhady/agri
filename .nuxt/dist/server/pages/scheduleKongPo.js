exports.ids = [73,21,40,42,43,44,45];
exports.modules = {
...
/* harmony default export */ var scheduleKongPovue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getScheduleIpah1: function () {
      this.$axios // .$get("http://139.59.109.48/api/schedule/kongPo")
      // .$get("http://127.0.0.1:5000/api/schedule/kongPo")
      .$get("http://159.223.55.150/api/schedule/kongPo").then(response => {
        response.forEach(i => {
          console.log(i);
    ...
    getScheduleIpah1Nutrient: function () {
      ...
      .$get("http://159.223.55.150/api/schedule/kongPo/nutrient") // .$get("http://139.59.109.48/api/schedule/kongPo/nutrient")
      .then(response => {
        response.forEach(i => {
    ...
    sendScheduleIpah1: function (date, time, duration, substance) {
      ...
      .$post("http://159.223.55.150/api/setSchedule/kongPo", {
    ...
    sendScheduleIpah1Nutient: function (date, duration) {
      ...
      .$post("http://159.223.55.150/api/setSchedule/kongPo/nutrient", {
        date: date,
        time: "05:00:00",
        duration: duration
      }).then(response => {
    ...
    sendSchedule: function () {
      this.sendScheduleIpah1(this.selectedDate, this.allTime, this.allDuration, this.allSubstance);
